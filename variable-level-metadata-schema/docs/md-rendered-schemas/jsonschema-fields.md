...
| ------------------------------------- | ----------- |
| [trueValues items](#trueValues_items) | -           |
...
| Each item of this array must be         | Description |
| --------------------------------------- | ----------- |
| [ontology_id items](#ontology_id_items) | -           |
...
| Each item of this array must be                     | Description |
| --------------------------------------------------- | ----------- |
| [standardsMappings items](#standardsMappings_items) | -           |
...
| Each item of this array must be                 | Description |
| ----------------------------------------------- | ----------- |
| [relatedConcepts items](#relatedConcepts_items) | -           |
...
| Each item of this array must be                                       | Description |
| --------------------------------------------------------------------- | ----------- |
| [categoricalMarginals items](#univarStats_categoricalMarginals_items) | -           |
